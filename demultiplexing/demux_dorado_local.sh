...
# ==============================================================================
# Local Demultiplexing Script for Oxford Nanopore Data using Dorado
#
# Processes all BAMs in a list sequentially on the local machine.
# Demultiplexes barcoded reads by kit name and emits per-barcode BAMs.
#
# USAGE:
#   bash demux_dorado_local.sh --bamlist bams.list --kit SQK-NBD114-24 [OPTIONS]
#
# REQUIRED ARGUMENTS:
